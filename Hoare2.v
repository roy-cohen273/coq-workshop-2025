...
(** **** Exercise: 3 stars, standard (square_simpler_outer_triple_valid)
...
(** **** Exercise: 4 stars, standard (dpow2_down_correct)
...
(** Solve the (exam) exercise in the accompanying PDF file.
   ...
   Note that is_even(Y) and division are implemented here using a loop. *)
